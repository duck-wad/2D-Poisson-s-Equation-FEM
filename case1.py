...
# CASE 1: set temp to bottom and top edges

def generate_mesh(subdivisions, domain_size, input_filename, point_sources, bottom_temp, top_temp, flux_value, k):
    # Generate nodes
...
generate_mesh(subdivisions, domain_size, input_filename, point_sources, bottom_temp, top_temp, flux_value, k)
